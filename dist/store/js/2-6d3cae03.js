webpackJsonp([2], {
    268: function (t, e, n) {
        (function (e, a) {
            ...
            var o = n(70), r = n(28), s = n(275), i = c(s), u = n(274), l = c(u), f = e.createClass({
                displayName: "About",
        ...
        e = t.exports = n(126)(), e.push([t.id, ".style-1yXWTCUy{color:#7c2845}.back-2QF7naWo{background:url(" + n(273) + ") no-repeat;height:265px;width:241px;-webkit-transform:translateZ(0);transform:translateZ(0)}.c{background:#ff0;height:50px;width:50px}.about-a-1OFd7HWC{background:#000}", ""]), e.locals = {
